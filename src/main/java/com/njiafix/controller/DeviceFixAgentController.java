    ...
    public ResponseEntity<Map<String, Object>> executeFix(@RequestBody Map<String, String> data) {
        ...
        try {
            ...
            if ("simu".equals(deviceCategory)) {
                ...
                } else if ("adb_devices".equals(action)) {
                    cmd = List.of("adb", "devices");
                } else if ("reboot_bootloader".equals(action)) {
                    cmd = List.of("adb", "reboot", "bootloader");
                } else if ("reboot_recovery".equals(action)) {
                    cmd = List.of("adb", "reboot", "recovery");
                } else if ("battery_info".equals(action)) {
                    cmd = List.of("adb", "shell", "dumpsys", "battery");
                } else if ("device_info".equals(action)) {
                    cmd = List.of("adb", "shell", "getprop");
                }
